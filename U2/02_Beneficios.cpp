...
int main (){
    ...
    double score, money;
    char level, unacceptable,acceptable, deserving;
    ...
    if((score==0.0)||(score==0.4)||(score>=0.6)) {
        money=score*2400;
        cout << "Your score this year is: " << level; cout << "\n";
        cout << "The amout of money you will get is " << money; cout << " $";    }
    else {
        cout<< "This is not a valid score, please enter a new value";
    }
    cout <<endl;
